...
sub_title: "`r ifelse(params$location=='Landsdekkende','Nasjonale resultater',params$location)` --- `r params$date_display`"
header: "Prevalensundersøkelsen for helsetjenesteassosierte infeksjoner og antibiotikabruk \\newline `r ifelse(params$location=='Landsdekkende','Nasjonale resultater',params$location)` --- `r params$date_display`"
