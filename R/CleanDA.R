...
clean_da <- function(da, type = "sykehjem") {
  ...
  da[
    Klassifisering == "Helsetjenesteassosiert infeksjon" & IndikasjonCategorySykehus == "Nedre luftveisinfeksjon",
    IndikasjonCategorySykehusMedKlassifiseringNedreLuftveisinfeksjon := "Helsetjenesteassosiert nedre luftveisinfeksjon"
  ]
  da[
    Klassifisering == "Samfunnservervet infeksjon" & IndikasjonCategorySykehus == "Nedre luftveisinfeksjon",
    IndikasjonCategorySykehusMedKlassifiseringNedreLuftveisinfeksjon := "Samfunnservervet nedre luftveisinfeksjon"
  ]
  da[
    Klassifisering == "Medisinsk profylakse" & IndikasjonCategorySykehus == "Nedre luftveisinfeksjon",
